...
export * from './components/organismos/formularios/RegistrarMovimiento';
...
export * from './components/templates/AcercaDeTemplate';
export * from './components/templates/CentroAyudaTemplate';
...
export * from './pages/AcercaDe';
export * from './pages/CentroAyuda';
